...
//		AccountNumberLUHA();
	...
	public static void DataCoveredEntity() {
		...
		Response response = given().header("authorization", "Bearer " + AR1)
				...
				.body(requestBody).log().all().when().post("/entityCommon/api/entity").then().assertThat().statusCode(200).and()
				.log().all().body("messageKey", equalTo("SUCCESS")).extract().response();
	...
	public static void Auction() {
	     ...
	     // Send the POST request
	        Response response = RestAssured
	                ...
	                .body(jsonBody)
	                .contentType(ContentType.JSON)
	                .put("https://api.qa2.wci-registry.org/entityCommon/api/auction/f5652d70-2a6b-4fed-9e85-4f1a5f78b978")
	...
	public static void IsSubmitted() {
     ...
     // Send the POST request
        Response response = RestAssured
                ...
                .body(jsonBody)
                .contentType(ContentType.JSON)
                .put("https://api.qa2.wci-registry.org/entityCommon/api/isSubmitted/f5652d70-2a6b-4fed-9e85-4f1a5f78b978")
	...
	public static void SpecialAccount() {
     ...
     // Send the POST request
        Response response = RestAssured
                ...
                .body(jsonBody)
                .contentType(ContentType.JSON)
                .post("https://api.qa2.wci-registry.org/entityCommon/api/special-accounts/f5652d70-2a6b-4fed-9e85-4f1a5f78b978")
	...
	public static void EntityAccounts() {
     ...
     // Send the POST request
        Response response = RestAssured
                ...
                .headers(headers)
                .contentType(ContentType.JSON)
                .get("https://api.qa2.wci-registry.org/entityCommon/api/entity/f5652d70-2a6b-4fed-9e85-4f1a5f78b978/accounts")
